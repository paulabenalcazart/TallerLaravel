      ...
      <p class="fs-1">Listado de Solicitudes</p>
        <form action="{{ route('project.store') }}" method="post">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" name="tema" id="tema" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" required>
            </div>
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" name="observacion" id="observacion" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" required>
            </div>
            <div class="mb-3">
            <label for="usuario_externo" class="form-label">¿Usuario Externo?</label>
            <select class="form-select" name="usuario_externo" id="usuario_externo" required>
